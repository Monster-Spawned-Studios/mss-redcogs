...
class MinecraftJavaClient(BaseClient, socket_type=SOCK_STREAM):
    """
    A Minecraft Java RCON client.
    """
    ...
    def __init__(self, host: str, port: int, password: str, timeout: float = 10.0, frag_threshold: int = 4096):
        """
        Initialize the Minecraft Java client.

        Args:
            host (str): The host of the Minecraft Java server.
            port (int): The port of the Minecraft Java server.
            password (str): The password of the Minecraft Java server.
            timeout (float, optional): The timeout for the Minecraft Java server. Defaults to 10.0.
    ...
    def run(self, command: str, *args: str, encoding: str = "utf-8",
        ...
        """
        Run a command on the Minecraft Java server.
    ...
    def login(self, passwd: str, *, encoding: str = "utf-8") -> bool:
        """
        Perform a login to the Minecraft Java server.
    ...
    def close(self) -> bool:
        """Close the Minecraft Java server connection."""
        try:
            self._socket.close()
            return True
        except Exception as e:
            self.logger.error(
                f"Failed to close Minecraft Java server connection.\nError: {e}")
            return False
